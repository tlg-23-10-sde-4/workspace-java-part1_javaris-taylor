...
class DerivedDateTimeTest {
    ...
    public static void testPresidentsFirst100Days() {
        ...
        System.out.println(inauguration + " " + deadline);
        // TODO
    }
    ...
    public static void testEarlyRetirement() {
        // TODO
        LocalDate bday = LocalDate.of(1993, 3, 27);
    ...
    public static void testLaborDay() {
        // TODO
        LocalDate sept1 = LocalDate.of(1993, 9, 1);
    ...
    public static void testElectionDay() {
        // TODO
        LocalDate nov2 = LocalDate.of(2024, 11, 1);
        LocalDate election = nov2.with(nextOrSame(DayOfWeek.MONDAY));
        System.out.println(election.plusDays(1));
    }
    ...
    public static void testAnniversary() {
        // TODO
        LocalDate anniversay = LocalDate.of(1969, 6, 6).plusYears(50);
        LocalDate party = anniversay.with(TemporalAdjusters.nextOrSame(DayOfWeek.SATURDAY));
